...
Slider.prototype.createUI = function(){
	...
	for(let i=0;i<this.imgs.length;i++){
		htmlstr+='<img src="'+this.imgs[i]+'" style="position:absolute;top:0px;left:0;';
	...
	//ul li	
	htmlstr='<ul style="position:absolute;list-style:none;;left:550px;bottom:26px;z-index:1;">';
	for(let i=0;i<this.imgs.length;i++){
		htmlstr+= '<li style="margin-right:10px;float:left;';
...
Slider.prototype.showImg=function(outIndex,inIndex){
	...
	$img.eq(inIndex).css({"opacity":0}).animate({
		"opacity":1
	},300);
